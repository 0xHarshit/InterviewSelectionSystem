...
public class StudentLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AsyncStudentLogin().execute(params);
            }
        });
        ...
        btnRegisterPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentRegisterPage = new Intent(getApplicationContext(), StudentRegister.class);
    ...
    class AsyncStudentLogin extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            try {
                ...
                String queryUserExists = String.format("select * from student WHERE email='%s'", email);
...
//                    System.out.println(password);
                    ...
                    if (a.equals(password) == false) {
                        ...
                        String userId = resultSetUserExists.getString(2);
